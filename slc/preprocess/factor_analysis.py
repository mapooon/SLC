...
class FactorAnalysis():
	...
	def fit_transform(self,data):
		...
		transformed=pd.DataFrame(transformed,columns=["fa_"+str(i+1) for i in range(self.n_components)])
...
class Fa(Preprocess):
	...
	def fa(self,data):
		self.model=FactorAnalysis(cols=self.columns,n_components=self.n_components)
