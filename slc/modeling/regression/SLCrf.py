...
class SLCrf(Regression):
    ...
    def make_parser(self):
        ...
        parser.add_argument("-b","--no_bootstrap",dest="bootstrap",help="whether unuse bootstrap samples are used",action='store_const',const=False,default=True)
        return parser
