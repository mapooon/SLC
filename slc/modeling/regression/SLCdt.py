...
class SLCdt(Regression):
    ...
    def make_parser(self):
        ...
        parser.add_argument("-c","--criterion",dest="criterion",help="The function to measure the quality of a split",default="mse",type=str,choices=["mse","friendman_mse","mae"])
